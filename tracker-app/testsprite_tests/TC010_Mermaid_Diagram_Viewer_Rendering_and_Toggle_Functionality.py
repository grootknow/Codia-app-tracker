...
async def run_test():
    ...
    try:
        ...
        # -> Click on '📐 V10 Diagrams' button to open Mermaid Diagram Viewer and load an .mmd document from the database.
        frame = context.pages[-1]
        # Click on '📐 V10 Diagrams' button to open Mermaid Diagram Viewer
